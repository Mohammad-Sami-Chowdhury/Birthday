  ...
  return (
    <div className="font-dancing flex items-center justify-center min-h-screen p-4 overflow-hidden bg-neutral-100 font-sans">
      <div className="relative w-full max-w-[1200px] min-h-[500px] h-auto lg:h-[700px] p-4 md:p-6 lg:p-8 bg-[#fffaf6] rounded-2xl shadow-xl flex flex-col lg:flex-row items-center justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
        ...
        <motion.img className="absolute top-1 right-4 md:top-2 md:right-20 opacity-70 rotate-[15deg] z-10 w-[50px] md:w-[80px] lg:w-[100px] xl:w-[150px]" src={block3} alt="" {...float} />
        <motion.img className="absolute top-4 right-20 md:top-10 md:right-[300px] z-10 w-[70px] md:w-[120px] lg:w-[200px] xl:w-[250px]" src={block2} alt="" {...float} />
        <motion.img className="absolute bottom-10 left-1/2 transform -translate-x-1/2 md:bottom-[60px] md:left-[475px] opacity-70 z-10 w-[50px] md:w-[80px] lg:w-[100px] xl:w-[150px]" src={block3} alt="" {...float} />
        <motion.img className="absolute bottom-2 left-4 md:bottom-5 md:left-[200px] z-10 w-[60px] md:w-[100px] lg:w-[150px] xl:w-[200px]" src={block2} alt="" {...float} />
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  transform: `translateX(${offset}px) translateY(${offset}px) rotate(${-2 + offset}deg)`,
                }}
                animate={{
                  y: [0, -5, 0],
                  transition: {
          ...
          <AnimatePresence initial={false} custom={direction} mode="wait">
            ...
            >
              <div className="absolute -top-3 md:-top-4 right-0 md:right-[0px] transform -translate-x-1/2 w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 bg-transparent">
                <img src={paperclip} alt="paperclip" className="w-full h-full" />
              </div>
